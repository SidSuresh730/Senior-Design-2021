  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% px4demo_AttitudeControllerWit_B.z
	  section.data(1).logicalSrcIdx = 9;
	  section.data(1).dtTransOffset = 0;
	
	  ;% px4demo_AttitudeControllerWit_B.x
	  section.data(2).logicalSrcIdx = 10;
	  section.data(2).dtTransOffset = 1;
	
	  ;% px4demo_AttitudeControllerWit_B.y
	  section.data(3).logicalSrcIdx = 11;
	  section.data(3).dtTransOffset = 2;
	
	  ;% px4demo_AttitudeControllerWit_B.r
	  ...
	  ;% px4demo_AttitudeControllerWit_B.NOT_b
  ...
  targMap.checksum0 = 58841269;
  targMap.checksum1 = 1875853826;
  targMap.checksum2 = 1955367077;
  targMap.checksum3 = 280503276;
